...
public:
	...
	void movePieceToTest(int colPar, int rowPar);
	bool getVisibility();
	bool getIsPieceTaken();
	void setPieceIsTaken();
	void setPieceIsNotTaken();
	...
	void outputAllPossMoves(bool &hasLegalMoves);
	void clearLegalMoveArray();
	bool getIsPieceAttackingKing();
	bool isInCheck();
	bool testMoveIsCheckAllowed(int moveToColumn, int moveToRow);
	void clearAllLegalMoveArrays();
	void setAllLegalMoveArrays();
	void applyCheckToPiece();
	void applyCheckToOwnPieces();
	void clearOppLegalMoveArrays();
	void setOppLegalMoveArrays();
	bool isCheckMate();
};